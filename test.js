...
const clampTests = [
  {
    ...
    args: ['Just a piece of text. Nothing interesting. Test.', 0.7, ' '],
    result: 'Just a piece of text.'
  },
  {
    name: 'Test 2 - serial key',
    args: ['serial-keykey-aj32hd-rreeww', 0.5, '-', true],
    result: 'aj32hd-rreeww'
  },
  {
    name: 'Test 3 - digits',
    args: ['1234567890', 0.6, '', true],
    result: '567890'
  },
  {
    name: 'Test 4 - 1% of string ("")',
    args: ['Just a piece of text.', 0.01, '', true],
    result: ''
  },
  {
  ...
  },
  {
    ...
    args: ['Just a piece of text.', 0.99, '.', true],
    result: ''
  },
  {
    name: 'Test 7 - 99% of string ("")',
    args: ['Just a piece of text.', 0.99, '-'],
    result: ''
  },
  {
    name: 'Test 8 - coeff = 2 (max - 1)',
    args: ['Just a piece of text.', 2, ' ', true],
    result: 'Just a piece of text.'
  },
  {
    name: 'Test 9 - coeff = -0.5 (min - 0)',
    args: ['Just a piece of text.', -0.5, ' ', true],
    result: ''
  },
  {
